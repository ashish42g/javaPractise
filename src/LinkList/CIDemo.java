...
class CIDemo {
    ...
    // ListInfo is necessary because buildList() must return two pieces of information
    ...
    static void buildList(ListInfo li, String[] words) {
        ...
        // Initialize last reference variable to simplify append and make concatenation possible.
        li.last = li.top;
        for (int i = 1; i < words.length; i++) {
            ...
            // Advance last reference variable to simplify append and make concatenation possible
